...
import type { Key, PublicNonces } from "../../aa-schnorr-multisig-sdk/src/types"
...
describe("testing multiSigUserOp", () => {
  it("should serialize and deserialize properly", () => {
    ...
    for (let index = 0; index < 3; index++) {
      ...
      const signer = createSchnorrSigner(`0x${keyPair.privateKey.toHex()}`)
    ...
    const multiSigUserOp = new MultiSigUserOp(publicKeys, publicNonces, opHash, opRequest)

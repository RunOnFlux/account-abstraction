...
export { pk1, pk2, pk3, localhost, provider, wallet, wallet2, wallet3, addressOne, addressTwo, addressThree, addressFour }
...
export const OWNER_ROLE_HASH = utils.solidityKeccak256(["string"], ["OWNER_ROLE"])
export const SIGNER_ROLE_HASH = utils.solidityKeccak256(["string"], ["SIGNER_ROLE"])
